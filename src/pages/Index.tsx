        ...
        <div className="flex-1 flex flex-col overflow-y-auto min-h-screen">
          <main className="flex-1">
            ...
            <Route path="/management/sales/edit-special-price-package/:id" element={<EditSpecialPricePackage />} />
              ...
              <Route path="/installation/archived-orders" element={
                <ProtectedRoute requiredPermission="installation-archived-orders">
                  <ArchivedInstallationOrders />
                </ProtectedRoute>
              } />
              ...
              <Route path="/management/discounts-offers/edit/:id" element={<EditDiscountOffer />} />
