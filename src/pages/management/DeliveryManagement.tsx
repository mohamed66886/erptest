...
const DeliveryManagement: React.FC = () => {
  ...
  useEffect(() => {
    console.log('👤 Current User in DeliveryManagement:', currentUser);
  ...
  return (
    <div className="w-full p-4 sm:p-6 space-y-8 min-h-screen" dir="rtl">
      {/* Header */}
      <Helmet>
        <title>إدارة التوصيلات | ERP90 Dashboard</title>
        <meta name="description" content="إدارة التوصيلات والمستودعات والطلبات والتوصيل ERP90 Dashboard" />
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-1">إدارة التوصيلات</h1>
