...
=        <p class="font-weight-bold">نظام إدارة الموارد ERP90</p>
  ...
  return (
    <>
      <Helmet>
        <title> فواتير المبيعات | ERP90 Dashboard</title>
        <meta name="description" content=" فواتير المبيعات، عرض وطباعة فواتير العملاء، ERP90 Dashboard" />
        <meta name="keywords" content="ERP, فواتير, مبيعات, عملاء, ضريبة, طباعة, Sales, Invoice, Report, Tax, Customer" />
      </Helmet>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex flex-col ">
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-1"> فواتير المبيعات</h1>
          <p className="text-gray-600 dark:text-gray-400">إدارة وعرض  فواتير المبيعات</p>
        </div>
      </div>
